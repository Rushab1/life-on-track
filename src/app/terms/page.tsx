  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10">
      ...
      <div className="card p-6 space-y-6 text-sm text-stone-300 leading-relaxed">
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">1. The service</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">2. Your account and data</h2>
          <p>
            ...
            the{" "}
            <a className="text-indigo-400 hover:text-indigo-300 underline" href="/privacy">
              Privacy Policy
            </a>
            .
          </p>
        ...
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">3. Not medical advice</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">4. Third-party services</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">5. Acceptable use</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">6. Warranty and liability</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">7. Changes and termination</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-stone-100 mb-2">8. Contact</h2>
          <p>
            Questions:{" "}
            <a
